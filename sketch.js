...
function createAliens() {
    ...
    for (i = 0; i < 24; i++) {
        ...
        if (startingX > width - 30) { //(-30) readjust till aliens /row falls within correct row
    ...
    for (let bullet of bullets) {
        ...
        for (let alien of aliens) {
            ...
            if (
                ...
                !bullet.hit && alien.alive //bullet never hit & alien alive
            ) {
